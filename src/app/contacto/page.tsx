            ...
            <div className="grid lg:grid-cols-2 gap-16">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="coaching-personal">Coaching Personal Integral</option>
                      <option value="protocolo-keto">Protocolo Keto Profesional</option>
                      <option value="desarrollo-creativo">Desarrollo Creativo Sistemático</option>
                      <option value="metodo-linguistico">Método Keto-Lingüístico</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Describe tu situación actual, objetivos específicos y cómo puedo ayudarte en tu proceso de transformación..."
                    />
                  </div>
                  ...
                  {submitStatus === 'success' && (
                    <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                      ...
                      <p className="text-green-700 text-sm mt-1">
                        Te contactaré en las próximas 24-48 horas para coordinar tu consulta inicial.
                      </p>
                    </div>
                  )}
              ...
              <div className="space-y-8">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Para consultas especializadas y coaching personalizado
                        </p>
                      </div>
                    </div>
                ...
                <div className="professional-card rounded-2xl p-6">
                  <h4 className="font-semibold text-brand-forest mb-4">⏱️ Tiempos de Respuesta</h4>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Formulario profesional:</span>
                      <span className="font-medium text-brand-forest">24-48h</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Telegram (consultas):</span>
                      <span className="font-medium text-brand-forest">2-6h</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Coaching personalizado:</span>
                      <span className="font-medium text-brand-forest">Cita previa</span>
                    </div>
                  </div>
                </div>
              </div>
