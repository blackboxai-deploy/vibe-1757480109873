            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-4 professional-card rounded-xl">
                    <div className="text-2xl text-brand-forest font-bold">5+</div>
                    <div className="text-sm text-gray-600">Años de Experiencia</div>
                  </div>
                  <div className="text-center p-4 professional-card rounded-xl">
                    <div className="text-2xl text-brand-coral font-bold">50+</div>
                    <div className="text-sm text-gray-600">Recursos Creados</div>
                  </div>
                  <div className="text-center p-4 professional-card rounded-xl">
                    <div className="text-2xl text-brand-sage font-bold">100%</div>
                    <div className="text-sm text-gray-600">Enfoque Natural</div>
                  </div>
                </div>
              ...
              <div className="relative">
                <div className="professional-card rounded-2xl overflow-hidden">
                  <img 
                    src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/f2a5075f-2a68-45a8-8f16-7f60d815b34a.png"
                    alt="Mi Vida Keto ALMA CREATIVA - Transformación profesional" 
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="professional-card rounded-2xl p-8 group hover:shadow-xl transition-all duration-300">
                ...
                <div className="space-y-4">
                  ...
                  <button className="w-full border border-brand-coral text-brand-coral hover:bg-brand-coral hover:text-white formal-button py-2">
                    🛒 Ver en Hotmart
                  </button>
                </div>
              ...
              {/* Coaching Personal */}
              <div className="professional-card rounded-2xl p-8 group hover:shadow-xl transition-all duration-300">
                <div className="w-16 h-16 earth-accent rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <span className="text-2xl text-white">🎯</span>
                </div>
                <h3 className="font-serif text-2xl font-bold text-brand-forest mb-4">
                  Coaching Personal
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Sesiones individualizadas de coaching nutricional y desarrollo creativo con metodología probada.
                </p>
              ...
              <div className="professional-card rounded-2xl p-8 group hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Accede a tips, recetas, ejercicios creativos y contenido de valor sin costo alguno.
                </p>
                <div className="text-center">
                  <Link
                    href="/recursos"
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <nav className="flex flex-col space-y-2">
                ...
                <Link href="/recursos" className="text-sm opacity-80 hover:opacity-100 transition-opacity duration-200">
                  Recursos
                </Link>
            ...
            {/* Contact */}
            <div className="space-y-4">
              <h3 className="font-semibold">Contacto Profesional</h3>
